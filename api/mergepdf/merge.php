...
try {
	if (isset($_SESSION[$session_logged])) {
		...
		if ($items) {
			...
			$path_output = "../../file/allegati/merge_" . $user->username . "_" . microtime(true) . ".pdf";
			$fullpath_output = __DIR__ . "/". $path_output;

			$cmd = "gs -q -dNOPAUSE -dBATCH -sDEVICE=pdfwrite -sOutputFile='$fullpath_output' ";		// metto gli apici perchè non accetta le cartelle con spazi
