	...
	if (isset($_SESSION[$session_logged])) {
		...
		if ($items) {
			...
			foreach ($items as $item) {
				...
				$path_output = "../../file/allegati/" . $user->username . "_" . microtime(true) . "_compressed.pdf";
				$fullpath_output = __DIR__ . "/". $path_output;

				$cmd = "gs -q -dNOPAUSE -dBATCH -sDEVICE=pdfwrite -dCompatibilityLevel=1.4 -dPDFSETTINGS=/ebook -sOutputFile='$fullpath_output' '$fullpath'";		// metto gli apici perchè non accetta le cartelle con spazi
